...
dx=1; % cm
dy=1; % cm
Nx = 60; % augmente la taille -> plus de calculs et on voit bien que le champs de potentiels s etend un peu plus
Ny = 60; % donc la fenêtre d observation à son importance sur la simulation
